...
const WhatsAppButton: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
      {/* Tooltip */}
      {showTooltip && (
        <div className="bg-white rounded-2xl shadow-xl p-4 max-w-xs border border-green-100 animate-fade-in">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="font-bold text-sm text-gray-900">Remax Monar</p>
      ...
      <button
        ...
        className="w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-lg hover:shadow-green-300 flex items-center justify-center transition-all duration-300 hover:scale-110 animate-pulse-slow group relative"
